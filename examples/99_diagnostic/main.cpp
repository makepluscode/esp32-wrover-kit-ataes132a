 ...
 * 4. Loads Test Keys into Slots 0 and 1 using Direct Write (for Unlocked Chips).
 */
...
// Bit 0 (ExtCrypto): 1
// Bit 1 (Inbound): 0 (Disabled to avoid Auth requirement conflict)
// Bit 2 (Outbound): 1
// Bit 3 (Random): 1
// Bit 4 (AuthKey): 0 (Not required for usage)
const uint8_t KEY_CONFIG_OPEN[4] = {0x0D, 0x00, 0x00, 0x00};
